/**
 * Custom Column MTColumnDateField
 * Create by: dvthang:01.04.2017
 */
Ext.define('QLDT.view.control.column.MTColumnDateField', {
    extend: 'Ext.grid.column.Date',
    xtype: 'MTColumnDateField',

    cls: 'cls-mtcolumn-datefield-theme',
    readOnly: false,
    allowBlank: true,
    filterable: true,
    ...
    dataType: QLDT.common.Enumaration.DataType.DateTime,
