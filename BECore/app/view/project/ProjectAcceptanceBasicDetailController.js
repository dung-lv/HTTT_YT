 ...
 */
Ext.define('QLDT.view.project.ProjectAcceptanceBasicDetailController', {
    extend: 'QLDT.view.base.BasePageDetailController',

    requires: ['QLDT.view.base.BasePageDetailController'],

    alias: 'controller.ProjectAcceptanceBasicDetail',

    apiController: 'ProjectAcceptanceBasics',
    ...
    */
    ...
    initData: function (record) {
        ...
        if (me.editMode != QLDT.common.Enumaration.EditMode.Edit) {
            ...
            record.set("EstablishedDate", newDate);
            record.set("MeetingDate", newDate);
        }
    },
