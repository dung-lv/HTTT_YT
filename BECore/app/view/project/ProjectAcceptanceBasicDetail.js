 ...
 */
Ext.define('QLDT.view.project.ProjectAcceptanceBasicDetail', {
    extend: 'QLDT.view.control.MTPanel',
    xtype: 'app-projectacceptancebasicdetail',
    requires: [
        'QLDT.view.control.MTPanel',
        'QLDT.view.project.ProjectAcceptanceBasicDetailController',
        'QLDT.view.project.ProjectAcceptanceBasicDetailModel',
        'QLDT.view.attach.ProjectAcceptanceBasic_AttachDetail',
        'QLDT.view.control.MTButton'
    ],
    controller: 'ProjectAcceptanceBasicDetail',
    viewModel: 'ProjectAcceptanceBasicDetail',
                ...
                { text: 'Kích thước', xtype: 'MTColumnNumberField', dataIndex: 'FileSize', width: 120, align: 'center' },
                {
                    ...
                    items: [{
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            var rec = grid.getStore().getAt(rowIndex), ID = rec.get("ProjectAcceptanceBasic_AttachDetailID");
                            if (rec.get("IsTemp")) {
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            ...
                            if (store) {
                                var frm = Ext.create('QLDT.view.attach.ProjectAcceptanceBasic_AttachDetail');
                                if (frm) {
