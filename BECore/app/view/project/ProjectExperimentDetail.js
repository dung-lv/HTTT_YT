 ...
 */
Ext.define('QLDT.view.project.ProjectExperimentDetail', {
    extend: 'QLDT.view.base.BasePopupDetail',
    xtype: 'app-projectexperimentdetail',
    requires: [
        'QLDT.view.base.BasePopupDetail',
        'QLDT.view.project.ProjectExperimentDetailController',
        'QLDT.view.project.ProjectExperimentDetailModel'

    ],

    controller: 'ProjectExperimentDetail',
    viewModel: 'ProjectExperimentDetail',
                    ...
                    items: [{
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            ...
                            QLDT.utility.Utility.downloadFile({
                                ID: rec.get("ProjectExperiment_AttachDetailID"),
                                FT: rec.get("FileType"),
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            ...
                            if (store) {
                                var frm = Ext.create('QLDT.view.attach.ProjectExperiment_AttachDetail');
                                if (frm) {
