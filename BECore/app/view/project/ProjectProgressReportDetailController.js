 ...
 */
Ext.define('QLDT.view.project.ProjectProgressReportDetailController', {
    extend: 'QLDT.view.base.BasePopupDetailController',

    requires: ['QLDT.view.base.BasePopupDetailController'],

    alias: 'controller.ProjectProgressReportDetail',
  ...
  */
    initData: function (record) {
        ...
        if (me.editMode != QLDT.common.Enumaration.EditMode.Edit) {
            ...
            record.set("DateReport", newDate);
            record.set("DateCheck", newDate);
        }
    },
    /*
     * Thực hiện sự kiện thay đổi giá trị của ComboBox termID
     * Create by: laipv:25.02.2018
     */
    change_termID: function (sender, newValue, oldValue, eOpts) {
        var me = this,
        termName = Ext.ComponentQuery.query("#termName", me.getView())[0];
        termID = Ext.ComponentQuery.query("#termID", me.getView())[0];
        //
        termName.setValue(termID.rawValue);
    },
