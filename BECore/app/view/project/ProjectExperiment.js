 ...
 */
Ext.define('QLDT.view.project.ProjectExperiment', {
    extend: 'QLDT.view.base.BaseList',
    xtype: 'app-projectexperiment',
    requires: [
        'QLDT.view.base.BaseList',
        'QLDT.view.project.ProjectExperimentController',
        'QLDT.view.project.ProjectExperimentModel',
        'QLDT.view.project.ProjectExperimentDetail'
    ],
    controller: 'ProjectExperiment',
    viewModel: 'ProjectExperiment',
    ...
    */
    getColumns: function () {
        var me = this;
        return [
            { text: 'Thử nghiệm ngày', dataIndex: 'ToDate', width: 130, xtype: 'MTColumnDateField' },
                       ...
                       items: [
                               {
                                   ...
                                   fieldLabel: 'Kế hoạch thử nghiệm',
                                   name: 'planExperiment',
                                   buttonText: '',
                                   buttonConfig: {
            ...
            items: [
                {
                    xtype: 'MTGrid',
                    store: store,
                    appendCls: 'grid-file-experiment',
                    itemId: 'grdMaster',
