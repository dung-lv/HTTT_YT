 ...
 */
Ext.define('QLDT.view.project.ProjectWorkshopController', {
    extend: 'QLDT.view.base.BaseListController',

    requires: ['QLDT.view.base.BaseListController'],

    alias: 'controller.ProjectWorkshop',
                ...
                if (proxy) {
                    ...
                    store.load({
                        callback: function (records, operation, success) {
                            ...
                            Ext.each(Ext.select(".form-workshop .file-download").elements, function (element) {
  ...
  */
    getPageDetail: function () {
        return 'QLDT.view.project.ProjectWorkshopDetail';
    },
