 ...
 */
Ext.define('QLDT.view.project.ProjectAcceptanceManageDetailController', {
    extend: 'QLDT.view.base.BasePageDetailController',

    requires: ['QLDT.view.base.BasePageDetailController'],

    alias: 'controller.ProjectAcceptanceManageDetail',

    apiController: 'ProjectAcceptanceManages',
