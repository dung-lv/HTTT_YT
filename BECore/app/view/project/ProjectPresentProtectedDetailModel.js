 ...
 */
Ext.define('QLDT.view.project.ProjectPresentProtectedDetailModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.ProjectPresentProtectedDetail',

    requires:[
        'QLDT.model.ProjectPresentProtected',
         'QLDT.view.control.MTStore'
    ],
    stores: {
        masterStore: {
            model: 'QLDT.model.ProjectPresentProtected',
            data:[
