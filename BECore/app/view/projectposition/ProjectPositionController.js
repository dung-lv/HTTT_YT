 ...
 */
Ext.define('QLDT.view.projectposition.ProjectPositionController', {
    extend: 'QLDT.view.base.BaseListController',

    requires:['QLDT.view.base.BaseListController'],

    alias: 'controller.ProjectPosition',

    apiController: 'ProjectPositions',
   ...
   */
    getPageDetail: function () {
        return 'QLDT.view.projectposition.ProjectPositionDetail';
    }
