/**
 * Controller thêm tệp đính kèm của ProjectAcceptanceBasic
 */
Ext.define('QLDT.view.attach.ProjectAcceptanceBasic_AttachDetailController', {
    extend: 'QLDT.view.base.BaseController',

    requires: ['QLDT.view.base.BaseController'],

    alias: 'controller.ProjectAcceptanceBasic_AttachDetail',
    ...
    */
    bindingForm: function () {
        var me = this,
         txtContents = Ext.ComponentQuery.query('#txtContents', me.getView())[0];
        if (txtContents && me.masterData) {
            txtContents.setValue(me.masterData.get("Contents"));
        }
    },
            ...
            form.submitWithFile(function (rep) {
                if (rep.Success && Ext.isArray(rep.Data)) {
                    ...
                    if (Ext.isArray(rep.Data) && rep.Data.length > 0) {
                        ...
                        if (me.masterData) {
                            me.masterData.set("Contents", contents);
                        }
                    }
                    view.destroy();
                }
