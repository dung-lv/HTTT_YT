 ...
 */
Ext.define('QLDT.view.attach.ProjectAcceptanceManage_AttachDetailController', {
    extend: 'QLDT.view.base.BaseController',

    requires: ['QLDT.view.base.BaseController'],

    alias: 'controller.ProjectAcceptanceManage_AttachDetail',
