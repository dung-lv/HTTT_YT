 ...
 */
Ext.define('QLDT.view.attach.ProjectWorkshop_AttachDetail', {
    extend: 'QLDT.view.control.MTWindow',
    xtype: 'app-projectworkshop_attachdetail',
    requires: [
        'QLDT.view.control.MTWindow',
        'QLDT.view.attach.ProjectWorkshop_AttachDetailController',
        'QLDT.view.attach.ProjectWorkshop_AttachDetailModel',
        'QLDT.view.control.MTFilefield'

    ],

    controller: 'ProjectWorkshop_AttachDetail',
    viewModel: 'ProjectWorkshop_AttachDetail',
