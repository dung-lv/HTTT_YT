 ...
 */
Ext.define('QLDT.view.attach.Project_AttachDetail', {
    extend: 'QLDT.view.control.MTWindow',
    xtype: 'app-project_attachdetail',
    requires: [
        'QLDT.view.control.MTWindow',
        'QLDT.view.attach.Project_AttachDetailController',
        'QLDT.view.attach.Project_AttachDetailModel',
        'QLDT.view.control.MTFilefield'

    ],

    controller: 'Project_AttachDetail',
    viewModel: 'Project_AttachDetail',
